    ...
    <>
      <footer className="text-center lg:text-left bg-gray-100 text-gray-600">
            ...
            "
              >
                <svg
                  ...
                  data-prefix="fas"
                  data-icon="cubes"
                  className="svg-inline--fa fa-cubes w-4 mr-3"
                  role="img"
              ...
              <p>
                From the deeps of the ocean, we present to you quality and
                original content. Keep visiting this page to gets your hands on
                exciting info. Learn. Absorb. Share
              </p>
            </div>
            <div className="">
        ...
        <div className="text-center p-6 bg-gray-200">
          ...
          <a className="text-gray-600 font-semibold">The Curious Whale</a>
        </div>
      </footer>
    </>
  );
